...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Yepin") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Yepin的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br>本站的正常访问由Vercel提供技术支持 网页基于Hexo(theme-Fomalhaut)框架开发</div>`
      : `<div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br>本站的正常访问由Vercel提供技术支持 网页基于Hexo(theme-Fomalhaut)框架开发</div>`)
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://registry.npmmirror.com/ushio-api-img-wallpaper/1.121.10/files/img_2021-01-17_1920x1080_96_background_normal.jpg);
    --darkmode-bg:url(https://p5.qhimg.com/bdr/__100/t0179510282339c5eb8.jpg);
    --mobileday-bg: url(https://p5.qhimg.com/bdm/1000_618_85/t01961d8879edfbd0ff.jpg);
    --mobilenight-bg: url(https://p5.qhimg.com/bdr/__100/t0179510282339c5eb8.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
